//////////////////////////////////////////////////////////////////////////////////////
/* The macro takes as input a hole LIF file of xyzc 1024x1024,
...
for(s=0;s<NbSeries;s++){
	...
	if (channels!=1 || slices!=1) {
		...
		*/
		...
		roiManager("Show All");
		run("Flatten");
		//saveAs("Tiff", "C:/Users/p_our/Desktop/Find_Maxima_macro_results/IdentifiedMaxima/Foci_GFP_"+d2s(s+1,0)+".tif");
		saveAs("Tiff", "C:/Users/p_our/Desktop/Find_Maxima_macro_results/IdentifiedMaxima/Foci_GFP_1.tif");
		*/
